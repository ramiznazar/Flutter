...
$pageTitle = 'Crutox Admin - User Count Management';
                        ...
                        <div class="container-fluid">
                                    ...
                                    <div class="page-title-box">
                                        <div class="btn-group float-right">
                                            <ol class="breadcrumb hide-phone p-0 m-0">
                                                ...
                                                <li class="breadcrumb-item active">User Count Management</li>
                                            </ol>
                                        </div>
                                        <h4 class="page-title">User Count Management</h4>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="mt-0 header-title">Update User Count</h4>
                                            <p class="text-muted mb-4 font-14">Update the display user count and goal. This will be displayed on the app. You can set any number you want (e.g., 99,000/1,000,000) regardless of actual registered users.</p>
                                            ...
                                            <form action="" method="POST">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="number" class="form-control" name="goal_users" required placeholder="Enter goal user count" value="<?php echo htmlspecialchars($currentSettings['goal_users']); ?>" />
                                                    <small class="form-text text-muted">Target number of users to reach.</small>
                                                </div>
