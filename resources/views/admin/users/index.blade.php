                    ...
                    <nav aria-label="Page navigation">
                        <ul class="pagination justify-content-center">
                            ...
                            <li class="page-item {{ $currentPage == 1 ? 'disabled' : '' }}">
                                <a class="page-link" href="{{ route('admin.users.index', ['page' => $currentPage - 1, 'search' => $search]) }}" aria-label="Previous">
                            ...
                            @if($startPage > 1)
                                <li class="page-item">
                                    <a class="page-link" href="{{ route('admin.users.index', ['page' => 1, 'search' => $search]) }}">1</a>
                                </li>
                                @if($startPage > 2)
                            ...
                            @if($endPage < $totalPages)
                                ...
                                @endif
                                <li class="page-item">
                                    <a class="page-link" href="{{ route('admin.users.index', ['page' => $totalPages, 'search' => $search]) }}">{{ $totalPages }}</a>
                                </li>
                            @endif

                            {{-- Next Button --}}
                            <li class="page-item {{ $currentPage == $totalPages ? 'disabled' : '' }}">
                                <a class="page-link" href="{{ route('admin.users.index', ['page' => $currentPage + 1, 'search' => $search]) }}" aria-label="Next">
