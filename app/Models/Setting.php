...
class Setting extends Model
{
    ...
    public static function defaultAttributes(): array
    {
        return [
            ...
            'common_box_enabled'        => 1,
            'common_box_reward_type'    => 'booster',
            'common_box_booster_types'  => '2x,3x,5x',
            'common_box_booster_duration' => 10.00,
            'rare_box_cooldown'         => 5,
            'rare_box_ads'              => 3,
            'rare_box_min_coins'        => 5.00,
            'rare_box_max_coins'        => 15.00,
            'rare_box_enabled'          => 1,
            'rare_box_reward_type'      => 'booster',
            'rare_box_booster_types'    => '2x,3x,5x',
            'rare_box_booster_duration' => 10.00,
            'epic_box_cooldown'         => 10,
            'epic_box_ads'              => 6,
            'epic_box_min_coins'        => 15.00,
            'epic_box_max_coins'        => 50.00,
            'epic_box_enabled'          => 1,
            'epic_box_reward_type'      => 'booster',
            'epic_box_booster_types'    => '2x,3x,5x',
            'epic_box_booster_duration' => 10.00,
            'legendary_box_cooldown'    => 30,
            'legendary_box_ads'         => 10,
            'legendary_box_min_coins'   => 50.00,
            'legendary_box_max_coins'   => 200.00,
            'legendary_box_enabled'     => 1,
            ...
            'ad_booster_enabled'        => 0,
            'ad_booster_cooldown_hours' => 8.00,
            'ad_booster_duration_hours' => 1.00,
            'ad_booster_type'           => '3x',
            'ad_booster_max_per_day'    => 3,
        ];
    }
